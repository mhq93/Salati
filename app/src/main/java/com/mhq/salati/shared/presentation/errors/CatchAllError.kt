// CatchAllError.kt, LocationPermissionRequiredError.kt, LocationServicesDisabledError.kt
// (Apply this same pattern to all 4 error files)
...
@Composable
fun CatchAllError( // Also applies to LocationPermissionRequiredError, etc.
    errorMessage: String,
    onRetryClicked: () -> Unit,
