...
import com.mhq.salati.language.presentation.components.LanguageSelectionDialog
    ...
    if (!splashState.isLanguageSelected) {
        LanguageSelectionDialog(
            onLanguageSelected = { selectedLanguage ->
                splashViewModel.onIntent(SplashContract.Intent.SelectInitialLanguage(selectedLanguage))
            },
            onDismissRequest = {
        ...
        val startRoute: String = splashState.startDestination?.route ?: "onboarding"
            ...
            Scaffold(
                ...
                CompositionLocalProvider(LocalSnackbarHostState provides snackbarHostState) {
                    NavHost(
                        ...
                        composable(Screen.Home.route) { HomeContainer() }
                        ...
                        composable(Screen.PrayerTracker.route) { PrayerTrackerContainer() }
                        composable(Screen.Alarms.route) { CustomAlarmsContainer() }
                        composable(Screen.Settings.route) { SettingsContainer() }
                    }
                }
            }
